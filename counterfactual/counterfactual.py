...
class Counterfactual:
    ...
    def generateCounterfactual(self, featureVector, caseID, columnsName, minPermittedRange, maxPermittedRange, changeToOpposite, changeToLabel = None):
        ...
        try:
            ...
            return False, -1
        cfDataframe, distance = self.closestCounterfactual(featureVector, columnsName, cf.cf_examples_list[0].final_cfs_df)
        ...
        return pd.concat([originalInstanceDf, cfDataframe]), distance
    ...
    def closestCounterfactual(self, originalVector, columnsNames, cf):
        ...
        return cf.iloc[[bestIndex]].copy(), distances[bestIndex]
